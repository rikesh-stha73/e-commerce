...
<h3>Shopping Portal</h3>
     ...
     <div class="module-body m-t-20">
        ...
        <a href="http://facebook.com/Digihand.Nepal" class='active'><i class="icon fa fa-facebook"></i></a>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>+977-9841999977<br>+977-9808123456</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">admin@digihand.co.np</a></span>
                </div>
            </li>
